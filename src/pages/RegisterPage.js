      ...
      <div className="w-full max-w-md mx-auto p-8 border space-y-3 rounded-xl bg-zinc-50 text-gray-800">
        ...
        <form onSubmit={handleForm} className="space-y-6 ng-untouched ng-pristine ng-valid">
          <div className="space-y-1 text-sm">
            ...
            <input type="text" name="name" id="name" placeholder="name" className="w-full px-4 py-3 rounded-md border-gray-300 bg-white border text-gray-800 focus:border-cyan-600" />
          </div>
          <div className="space-y-1 text-sm">
          ...
          <button className="block w-full p-3 text-center rounded-sm text-gray-50 bg-cyan-600">Register</button>
        </form>
