        ...
        <div className="items-center lg:flex">
          <div className="w-full lg:w-1/2">
            <div className="lg:max-w-lg">
              ...
              {
                user?.uid ?
                  <Link to='/dashboard' className="px-5 py-2 mt-6 inline-block text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-cyan-600 hover:bg-cyan-500 focus:outline-none focus:bg-cyan-500">Go To Dashboard</Link>
                  :
