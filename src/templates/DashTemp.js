            ...
            <div className="h-full w-full p-3 space-y-2 border bg-gray-50 text-gray-800">
              ...
              <div className="divide-y divide-gray-300">
                <ul className="pt-2 pb-4 space-y-1 text-sm">
                  <li className="bg-gray-100 border text-gray-900">
                  ...
                  <li>
                    <Link to='/dashboard/add-task' className="flex items-center p-2 space-x-3 rounded-md">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
                  ...
                  <li>
                    <Link to='/dashboard/my-tasks' className="flex items-center p-2 space-x-3 rounded-md">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
                  ...
                  <li>
                    <Link to='/dashboard/completed-tasks' className="flex items-center p-2 space-x-3 rounded-md">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
