            ...
            <div className="sidebar h-full w-full p-3 space-y-2 border bg-gray-50 text-gray-800">
              ...
              <div className="divide-y divide-gray-300">
                <ul className="pt-2 pb-4 space-y-1 text-sm">
                  <li className="">
                    <NavLink to='/dashboard'
                      className={({ isActive }) => isActive && path === '/dashboard' ? 'active flex items-center p-2 space-x-3' : 'flex items-center p-2 space-x-3'}
                    >
                  ...
                  <li>
                    <NavLink to='/dashboard/add-task' className="flex items-center p-2 space-x-3">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
                  ...
                  <li>
                    <NavLink to='/dashboard/my-tasks' className="flex items-center p-2 space-x-3">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
                  ...
                  <li>
                    <NavLink to='/dashboard/completed-tasks' className="flex items-center p-2 space-x-3">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
                ...
                <ul className="pt-4 pb-2 space-y-1 text-sm">
                  ...
                  <li>
                    <button onClick={handleLogout} className="flex items-center p-2 space-x-3">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
